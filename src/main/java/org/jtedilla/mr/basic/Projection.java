...
import org.jtedilla.util.SecondarySort;
import org.jtedilla.util.Tuple;
import org.jtedilla.util.Utility;
 ...
 * Run
 * ----
 * hadoop jar $JAR_NAME $CLASS_NAME Dconf.path=/Users/jtedilla/fraud/mmfr.properties $IN_PATH $OUT_PATH
 * User: javierteso
 * Date: 3/03/2014
 */
public class Projection extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        if (operation.startsWith("grouping")) {
            ...
            //order by
            boolean orderby = job.getConfiguration().getInt("orderBy.field", -1) >= 0;
            if (orderby){
